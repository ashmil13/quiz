...
const QUESTIONS = [
  ...
  {
    id: 12,
    question: "[Read Carefully 1] ത്വൗറാത്ത് അവതരിച്ചതിനുശേഷം ഒരു ജനത മുഴുവനായി പൊതുശിക്ഷയാൽ നശിപ്പിക്കപ്പെട്ടിട്ടില്ലെന്ന വാദത്തിന്റെ അടിസ്ഥാനത്തിൽ, യാസീനിലെ രാജ്യം 'അന്താക്കിയ' ആകാൻ വഴിയില്ലന്ന് നിരീക്ഷിച്ച പണ്ഡിതൻ ആര്?",
    options: [
  ...
  {
    id: 16,
    question: "[Read Carefully 2] ആ സൽപുരുഷൻ ജനങ്ങൾക്ക് അപരിചിതനായിരുന്നുവെന്ന് ഖുർആനിലെ പ്രയോഗങ്ങളിൽ നിന്ന് വ്യക്തമാക്കിയ മുഫസ്സിർ ആര്?",
    options: [
  ...
  {
    id: 26,
    question: "[Read Carefully 3] 'കുല്ലുൻ ഫീ ഫലകിൻ യസ്ബഹൂൻ' എന്ന ആയത്തിൽ 'യസ്ബഹൂൻ' എന്ന ക്രിയ ബഹുവചനത്തിലും ബുദ്ധിജീവികൾക്ക് ഉപയോഗിക്കുന്ന രൂപത്തിലും വരാൻ കാരണമായി തഫ്സീറിൽ പറയുന്നതെന്ത്?",
    options: [
  ...
  {
    id: 39,
    question: "[Read Carefully 4] ദീർഘായുസ്സ് ലഭിക്കുമ്പോൾ മനുഷ്യന്റെ ശാരീരിക പ്രകൃതിയിൽ വിപരീതാവസ്ഥ (നുനക്കിസ്ഹു ഫിൽ ഖൽഖ്) വരുത്തുന്നുവെന്ന ആയത്ത് (68) സ്ഥാപിക്കുന്ന പ്രധാന യാഥാർത്ഥ്യമെന്ത്?",
    options: [
  ...
  {
    id: 44,
    question: "[Read Carefully 5] പച്ചമരത്തിൽ നിന്ന് തീയുണ്ടാക്കിത്തരുന്നവൻ എന്ന 80-ാം ആയത്തിന്റെ വ്യാഖ്യാനത്തിൽ, പുരാതന അറേബ്യയിൽ ഉരസി തീയുണ്ടാക്കാൻ ഉപയോഗിച്ചിരുന്ന രണ്ട് മരങ്ങൾ ഏതെല്ലാമാണ്?",
    options: [
  ...
  {
    id: 46,
    question: "[Read Carefully 10] സൂറത്തു യാസീൻ 52-ാം ആയത്തിലെ 'മൻ ബഅഥനാ മിൻ മർഖദിനാ' (ഞങ്ങളുടെ ഉറങ്ങുന്നിടത്തുനിന്ന് ഞങ്ങളെ എഴുന്നേൽപ്പിച്ചതാര്) എന്ന വാക്യത്തെക്കുറിച്ച് ഉബയ്യുബ്നു കഅ്ബ് (റ) വ്യക്തമാക്കിയ അഭിപ്രായം എന്താണ്?",
    options: [
  ...
  {
    id: 47,
    question: "[Read Carefully 6] 'അൽ-ഖാമൂസ്', 'ലിസാനുൽ അറബ്' എന്നീ പ്രമുഖ നിഘണ്ടുക്കളിൽ 'ബർസഖ്' എന്ന പദത്തിന് നൽകിയിട്ടുള്ള നിർവ്വചനം എന്താണ്?",
    options: [
  ...
  {
    id: 48,
    question: "[Read Carefully 7] 'ഹുജ്ജത്തുല്ലാഹിൽ ബാലിഗഃ' എന്ന വിഖ്യാത തത്ത്വചിന്താപരമായ ഗ്രന്ഥം രചിച്ച പണ്ഡിതൻ ആര്?",
    options: [
  ...
  {
    id: 49,
    question: "[Read Carefully 8] അഭൗതിക യാഥാർത്ഥ്യങ്ങളെ (ഖബ്റിലെ അനുഭവങ്ങൾ, മലക്കുകളുടെ സാന്നിധ്യം തുടങ്ങിയവ) ഉൾക്കൊള്ളുന്നതിൽ ജനങ്ങൾ സ്വീകരിക്കുന്ന മൂന്ന് നിലപാടുകളെ വിശകലനം ചെയ്ത രണ്ട് പ്രമുഖ പണ്ഡിതന്മാർ ആരെല്ലാം?",
    options: [
  ...
  {
    id: 50,
    question: "[Read Carefully 9] ഖബ്റിൽ വെച്ച് പാമ്പ് കടിക്കുന്ന വേദന അനുഭവപ്പെടുന്നത് ബാഹ്യനേത്രങ്ങൾ കൊണ്ട് കാണാൻ കഴിയാത്തതിന് ഇമാം ഗസ്സാലി (റ) നൽകുന്ന ഉപമ എന്ത്?",
    options: [
